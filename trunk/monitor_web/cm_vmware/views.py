...
from cm_vmware_settings import TETE, VMWARE_USER
...
class VMwareHostViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        try:
            ...
            server.connect(host_serializer.data['host_ip'], VMWARE_USER['NAME'], VMWARE_USER['PASSWORD'])
    ...
    def info(self, request, host_ip):
        try:
            ...
            if instance_name is None:
                ...
                server = VIServer()
                server.connect(host_ip, VMWARE_USER['NAME'], VMWARE_USER['PASSWORD'])
